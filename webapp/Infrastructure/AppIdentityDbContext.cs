...
namespace LivellPayRoll.Infrastructure
{
    public class AppIdentityDbContext : IdentityDbContext<AppUser>
    {
        ...
        public DbSet<T100> T100 { get; set; }
        ...
        public DbSet<AccrualTimeJournal> AccrualTimeJournal { get; set; }
        public DbSet<HelpDesc> HelpDesc { get; set; }
        ...
        public class IdentityDbInit: DropCreateDatabaseIfModelChanges<AppIdentityDbContext>
        {
            ...
            protected override void Seed(AppIdentityDbContext context)
            {
                ...
                base.Seed(context);
                context.Database.ExecuteSqlCommand("DBCC CHECKIDENT ('T105', RESEED, 1000)");
            }
        ...
        public void PerformInitialSetup(AppIdentityDbContext context)
        {
            ...
            AppRole role00 = new AppRole { Id = "R00", Name = "Governor" };
            ...
            Company company = new Company
            {
                ...
                TimeZone = "0",
                Email = "Governor@livellpayroll.com",
                PayFreq = "Weekly",
                RoundTo = "15",
            ...
            {
                UserName = "LivellPayrollGovernor",
                Email = "Governor@livellpayroll.com",
                EmailConfirmed = true,
                PayRollUser = "LivellPayrollGovernor",
                TimeZone = "0",
                LastLoginDate = DateTime.UtcNow,
                Company = company
            };
            var user = userMgr.FindByEmail("Governor@livellpayroll.com");
            if (user == null) {
